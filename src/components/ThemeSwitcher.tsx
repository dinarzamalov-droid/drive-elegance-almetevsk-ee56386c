...
const ThemeSwitcher = () => {
  ...
  return (
    <div className={`fixed bottom-[148px] right-4 md:bottom-[164px] md:right-6 z-50 flex flex-col gap-2 transition-opacity duration-300 ${isFooterVisible ? "opacity-0 pointer-events-none" : "opacity-100"}`}>
      <button
