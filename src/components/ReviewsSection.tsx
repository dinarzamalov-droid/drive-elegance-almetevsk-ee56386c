    ...
    <section id="reviews" className="section-padding">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {reviews.map((r, i) => (
            <AnimatedItem key={r.author} delay={i * 0.15}>
              <div className="bg-card-gradient gold-border rounded-2xl p-8 relative hover:gold-glow transition-shadow duration-500 h-full">
