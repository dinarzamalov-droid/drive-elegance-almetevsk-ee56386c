...
const faqs = [
  ...
  {
    q: "Что будет при ДТП?",
    a: "При наличии КАСКО — ремонт за счёт страховой. Без КАСКО — ремонт за счёт арендатора. В любом случае вызывайте ГИБДД и сообщите менеджеру.",
    tags: "дтп авария страховка каско",
  },
  {
