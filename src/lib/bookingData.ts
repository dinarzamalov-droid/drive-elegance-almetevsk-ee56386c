...
export const cars = [
  ...
  { value: "range-rover-sport", label: "Range Rover Sport", price: 20000, deposit: 40000, category: "premium" as CarCategory, specs: "340 л.с., полный привод, премиум SUV", extras: { mileage: 3000, delivery: 2500 }, vehicle: { year: 2019, vin: "—", enginePower: 340, plate: "С700ТС716", certNumber: "—", body: "ЛЕГКОВОЙ УНИВЕРСАЛ", color: "СВЕТЛО-СЕРЫЙ", fuel: "БЕНЗИН", fuelLevel: 60, fuelType: "100", mileageLimit: 300 } },
];
